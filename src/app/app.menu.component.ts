...
@Component({
    selector: 'app-menu',
    template: `
        <ul app-submenu [item]="sitemap" root="true" class="ultima-menu ultima-main-menu clearfix" [reset]="reset" visible="true"></ul>
    `
})
export class AppMenuComponent implements OnInit {
    ...
    sitemap: Array<{label:string, icon: string, routerLink?: string, command?: any, items?: Array<{label:string, icon: string, routerLink: string}>}>;

    constructor(@Inject(forwardRef(() => AppComponent)) public app:AppComponent) { }
    
    ngOnInit() {
        this.sitemap = this.app.userSitemap;
    }
}
